...
//
        ...
        listOfExerciseLoad.adapter = ArrayAdapter(this, R.layout.spinner_style, itemsExerciseLoad)
        listOfCategory.adapter = ArrayAdapter(this, R.layout.spinner_style, itemsCategory)
        listOfStrobism.adapter = ArrayAdapter(this, R.layout.spinner_style, itemsStrobism)
        listOfCountTime.adapter = ArrayAdapter(this, R.layout.spinner_style, itemsCountOfTime)
...
//         Обработчик нажатия на кнопку
        button.setOnClickListener {
            ...
            val user = Userr(
                dateOfBirth = "01.09.2020", // Пример даты рождения
                exerciseLoad = selectedExerciseLoad,        // Пример нагрузки
                isStrobism = isStrobism,          // Пример для стробизма
                categoryExercise = selectedCategory,  // Пример категории упражнения
                countOfTime = selectedCountTime          // Пример времени
